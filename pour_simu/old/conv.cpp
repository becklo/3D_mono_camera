...
void conv(int image[IMG_WIDTH][IMG_HEIGHT], int rows, int cols, int num_filtre, ac_fixed<28,10,true> sortie[IMG_WIDTH+16][IMG_HEIGHT+16]){//[IMG_WIDTH+16][IMG_HEIGHT+16]){
