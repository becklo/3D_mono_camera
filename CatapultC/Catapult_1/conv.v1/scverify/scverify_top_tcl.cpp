...
void scverify_top::debug(const char *varname, int flags, int count)
{
   ...
   if (strcmp(varname,"image_in:f52c8f3e-8279-4527-8ec1-c43d76fe290f-57:image_in") == 0) {
      xlator_p = image_in_transactor;
   }
   if (strcmp(varname,"image_out:f52c8f3e-8279-4527-8ec1-c43d76fe290f-58:image_out") == 0) {
      xlator_p = image_out_transactor;
   }
   if (xlator_p) {
...
void scverify_top::generate_sync() {
   ...
   static CATMON_EX_TYPE latency = 200851LL; // Total Cycles value
   static CATMON_EX_TYPE init_interval = 0LL;
   static CATMON_EX_TYPE csteps = 200851LL;
   static CATMON_EX_TYPE duration = latency - csteps + init_interval;
   static CATMON_EX_TYPE latest_write = 200851LL;
...
void scverify_top::generate_reset() {
      ...
      if (first || sc_time_stamp() == SC_ZERO_TIME)
      {
         ...
         image_in_transactor->reset_streams();
         image_out_transactor->reset_streams();
