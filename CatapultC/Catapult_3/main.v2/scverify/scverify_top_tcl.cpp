...
void scverify_top::debug(const char *varname, int flags, int count)
{
   ...
   if (strcmp(varname,"mask:d651eaab-b1f5-42d2-a640-0222cf74a3e7-56:mask") == 0) {
   }
   if (strcmp(varname,"filtre:d651eaab-b1f5-42d2-a640-0222cf74a3e7-58:filtre") == 0) {
   }
   if (strcmp(varname,"image_net:d651eaab-b1f5-42d2-a640-0222cf74a3e7-59:image_net") == 0) {
      xlator_p = image_net_transactor;
   }
   if (strcmp(varname,"image_floue:d651eaab-b1f5-42d2-a640-0222cf74a3e7-60:image_floue") == 0) {
      xlator_p = image_floue_transactor;
   }
   if (strcmp(varname,"image_error:d651eaab-b1f5-42d2-a640-0222cf74a3e7-61:image_error") == 0) {
      xlator_p = image_error_transactor;
   }
   if (strcmp(varname,"depth:d651eaab-b1f5-42d2-a640-0222cf74a3e7-62:depth") == 0) {
      xlator_p = depth_transactor;
   }
   if (strcmp(varname,"return:d651eaab-b1f5-42d2-a640-0222cf74a3e7-63:return") == 0) {
      xlator_p = return_transactor;
   }
   if (xlator_p) {
...
void scverify_top::generate_sync() {
   ...
   static CATMON_EX_TYPE latency = 625186LL; // Total Cycles value
   static CATMON_EX_TYPE init_interval = 0LL;
   static CATMON_EX_TYPE csteps = 625186LL;
   static CATMON_EX_TYPE duration = latency - csteps + init_interval;
   static CATMON_EX_TYPE latest_write = 625186LL;
...
void scverify_top::generate_reset() {
      ...
      if (first || sc_time_stamp() == SC_ZERO_TIME)
      {
         ...
         reset_deactivation_event.notify(100.0, SC_NS);
      } else {
         image_net_transactor->reset_streams();
         image_floue_transactor->reset_streams();
         image_error_transactor->reset_streams();
         depth_transactor->reset_streams();
         return_transactor->reset_streams();
