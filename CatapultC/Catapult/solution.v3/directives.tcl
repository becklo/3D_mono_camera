...
solution file add ./3D_mono_camera/Lecture.cpp -type C++ -exclude true
solution file add ./3D_mono_camera/depth.cpp -type C++ -exclude true
solution file add ./3D_mono_camera/ecriture.cpp -type C++ -exclude true
solution file add ./3D_mono_camera/conv.cpp -type C++ -exclude true
